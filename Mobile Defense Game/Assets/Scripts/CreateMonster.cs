...
public class CreateMonster : MonoBehaviour
{
    ...
    void Update()
    {
        if(gameManager.round <= gameManager.totalRound)
        {
            ...
            if(((spawnCount == 0 && timeGap > gameManager.roundReadyTime) || timeGap > gameManager.spawnTime)
            ...
            if(spawnCount == gameManager.spawnNumber && GameObject.FindGameObjectWithTag("Monster") == null)
            {
